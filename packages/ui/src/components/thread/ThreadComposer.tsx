      ...
      <div
        className={cn(
          ...
          isHero
            ...
            : "max-w-[49.5rem] rounded-[22px] border border-border/45 bg-card shadow-[0_12px_30px_rgba(48,72,118,0.07)] dark:border-white/[0.06] dark:shadow-[0_16px_34px_rgba(0,0,0,0.28)]",
