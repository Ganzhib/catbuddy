...
import type { MessageFrame, MessageFrameType } from './gateway-protocol.js'
...
export function validateMessageFrame(frame: unknown): frame is MessageFrame {
...
/** @deprecated Use validateMessageFrame */
export const validateFrame = validateMessageFrame
