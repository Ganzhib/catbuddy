/**
 * Browser Web client for learnbuddy Gateway (register / subscribe).
 */
...
export type WebGatewayStatus = 'disconnected' | 'connecting' | 'connected' | 'reconnecting'
