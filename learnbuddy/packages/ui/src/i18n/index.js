...
import { applyDocumentLocale, defaultLocale, fallbackLocale, LOCALE_STORAGE_KEY, normalizeLocale, persistLocale, resolveInitialLocale, } from "./config";
...
const syncLocaleSideEffects = (language) => {
